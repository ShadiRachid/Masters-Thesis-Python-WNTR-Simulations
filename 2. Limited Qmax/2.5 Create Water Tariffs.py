...
Energy_Tariff = pd.read_excel(r'Tariff.xlsx',index_col=0)
...
for T in Water_Tariff.columns:
    ...
    ax.set_title('Hourly Water Tariff: '+T,fontdict={'fontsize': 20} )
    ax.set_xlabel('time (h)', fontdict={'fontsize': 15})
    ax.set_ylabel('Tariff (factor)', color='blue', fontdict={'fontsize': 15})
    ax.set_xticks(hours)
