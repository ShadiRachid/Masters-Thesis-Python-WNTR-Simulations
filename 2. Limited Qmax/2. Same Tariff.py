...
for T in Tariff.columns:
    ...
    max_demand = total_hourly_demand(wn,water_tariff[T])['Total Demands'].max()
...
water_tariff.to_excel(r'2 Same Tariff Results/0.Water Tariffs.xlsx',header = True)     
energy_savings_percentage.to_excel(r'2 Same Tariff Results/1.Energy Savings Percentage.xlsx',header = True)
cost_savings_percentage.to_excel(r'2 Same Tariff Results/2.Cost Savings Percentage.xlsx',header = True)
revenue_increase_percentage.to_excel(r'2 Same Tariff Results/3.Revenue Increase Percentage.xlsx',header = True)
net_increase_percentage.to_excel(r'2 Same Tariff Results/4.Net Increase Percentage.xlsx',header = True)
total_demand_difference.to_excel(r'2 Same Tariff Results/5.Total Demand Difference.xlsx',header = True)
Demand_shifted_percentage.to_excel(r'2 Same Tariff Results/6.Demand Shifted Percentage.xlsx',header = True)  
...
writer1 = pd.ExcelWriter(r'2 Same Tariff Results/A. Demands.xlsx', engine='xlsxwriter')
...
writer1.save()
response_details.to_excel(r'2 Same Tariff Results/B. Response_Details.xlsx', header = True)
summary.to_excel(r'2 Same Tariff Results/C. Summary.xlsx',header = True)
hourly_results.to_excel(r'2 Same Tariff Results/D. Hourly Results.xlsx',header = True)
...
df = pd.read_excel('2 Same Tariff Results/2.Cost Savings Percentage.xlsx', index_col=0)
...
plt.savefig('2 Same Tariff Results/2.1 Cost Savings Percentage 3D.png')
plt.close()
...
plt.savefig('2 Same Tariff Results/2.2.1 Cost Saving Percentage 2D.png')
plt.close()
...
ax.plot(df4.index.tolist(), df4.mean(axis = 1).tolist()-df4.std(axis = 1),color='r', linestyle='dotted',linewidth = 3,label = 'μ-σ')
ax.legend(fontsize = 20)
plt.savefig('2 Same Tariff Results/2.2.2 Cost Saving Percentage 2D.png')
plt.close()

### 3.1 Revenue Decrease Percentages 3D ###
### 
df = pd.read_excel('2 Same Tariff Results/3.Revenue Increase Percentage.xlsx', index_col=0)
df.replace(np.nan,0,inplace = True)
df.columns = plotting_columns
df2 = pd.DataFrame(columns = ['x','y','z'])
j = 0
...
ax.plot_trisurf(X,Y,Z,cmap=cm.coolwarm)
plt.savefig('2 Same Tariff Results/3.1 Revenue Decrease Percentage 3D.png')
plt.close()
...
ax.legend(fontsize = 20)
plt.savefig('2 Same Tariff Results/3.2.1 Revenue Decrease Percentage 2D.png')
plt.close()
...
ax.plot(df4.index.tolist(), df4.mean(axis = 1).tolist()-df4.std(axis = 1),color='r', linestyle='dotted',linewidth = 3,label = 'μ-σ')
ax.legend(fontsize = 20)
plt.savefig('2 Same Tariff Results/3.2.2 Revenue Decrease Percentage 2D.png')
plt.close()

### 4.1 Net Increase Percentages 3D ###
### 
df = pd.read_excel('2 Same Tariff Results/4.Net Increase Percentage.xlsx', index_col=0)
df.replace(np.nan,0,inplace = True)
df.columns = plotting_columns
df2 = pd.DataFrame(columns = ['x','y','z'])
j = 0
...
ax.plot_trisurf(X,Y,Z,cmap=cm.coolwarm)
plt.savefig('2 Same Tariff Results/4.1 Net Increase Percentage 3D.png')
plt.close()
...
plt.savefig('2 Same Tariff Results/4.2.1 Net Increase Percentage 2D.png')
plt.close()
...
ax.plot(df4.index.tolist(), df4.mean(axis = 1).tolist()-df4.std(axis = 1),color='r', linestyle='dotted',linewidth = 3,label = 'μ-σ')
ax.legend(fontsize = 20)
plt.savefig('2 Same Tariff Results/4.2.2 Net Increase Percentage 2D.png')
plt.close()


### 6.1 Demand Shifted Percentages 3D ###
### 
df = pd.read_excel('2 Same Tariff Results/6.Demand Shifted Percentage.xlsx', index_col=0)
df.replace(np.nan,0,inplace = True)
df.columns = plotting_columns
df2 = pd.DataFrame(columns = ['x','y','z'])
j = 0
...
ax.plot_trisurf(X,Y,Z,cmap=cm.coolwarm)
plt.savefig('2 Same Tariff Results/6.1 Demand Shifted Percentage 3D.png')
plt.close()
...
ax.legend(fontsize = 20)
plt.savefig('2 Same Tariff Results/6.2.1 Demand Shifted Percentage 2D.png')
plt.close()
...
ax.plot(df4.index.tolist(), df4.mean(axis = 1).tolist()-df4.std(axis = 1),color='r', linestyle='dotted',linewidth = 3,label = 'μ-σ')
ax.legend(fontsize = 20)
plt.savefig('2 Same Tariff Results/6.2.2 Demand Shifted Percentage 2D.png')
plt.close()
...
### 
df = pd.read_excel('2 Same Tariff Results/B. Response_Details.xlsx', index_col=0)
...
plt.savefig('2 Same Tariff Results/B.1 % of Demand Shifted.png')
plt.close()
...
plt.savefig('2 Same Tariff Results/B.2 Total Demand Shifted.png')
plt.close()

### D Hourly Results Plots ###
### 
df = pd.read_excel('2 Same Tariff Results/D. Hourly Results.xlsx', index_col=0)
...
fig.tight_layout() 
plt.savefig('2 Same Tariff Results/D.1 Comparison_Total Demand & Tariff.png')
plt.close()
...
ax2.tick_params(axis='y', labelcolor='blue')
fig.tight_layout() 
plt.savefig('2 Same Tariff Results/D.2 Comparison_Cost & Energy Tariff.png')
plt.close()
...
ax2.tick_params(axis='y', labelcolor='blue')
fig.tight_layout() 
plt.savefig('2 Same Tariff Results/D.3 Comparison_Revenue & Water Tariff.png')
plt.close()
...
ax2.tick_params(axis='y', labelcolor='blue')
fig.tight_layout() 
plt.savefig('2 Same Tariff Results/D.4 Comparison_Net & Water Tariff.png')
plt.close()
...
ax2.tick_params(axis='y', labelcolor='blue')
fig.tight_layout() 
plt.savefig('2 Same Tariff Results/D.5 Comparison_shifted_demand_and_energy_difference.png')
plt.close()
...
ax2.tick_params(axis='y', labelcolor='blue')
fig.tight_layout() 
plt.savefig('2 Same Tariff Results/D.6 Demand_&_Energy_original.png')
plt.close()
...
ax2.tick_params(axis='y', labelcolor='blue')
fig.tight_layout() 
plt.savefig('2 Same Tariff Results/D.7 Demand_&_Energy_new.png')
plt.close()